package com.joindata.demo.pangu.idgen;
 ...
 * @date 2018年2月27日 下午4:26:43
 */
@JoindataWebApp(id = "DEMO.PANGU")
@EnableDisconf
@EnableIdgen
@EnableSwagger("ID 生成器例子")
public class App
{
    static
    {
        ...
        System.setProperty("app.version", "IdGen");
    ...
    // XXX 说明
    // - 要使用 ID 生成器，必须在 Disconf 中必须要有个 idgen.properties 文件，请登录 Disconf 在 DEMO.PANGU > IdGen 中查看
