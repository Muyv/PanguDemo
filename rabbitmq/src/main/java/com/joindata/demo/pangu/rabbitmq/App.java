package com.joindata.demo.pangu.rabbitmq;
...
import com.joindata.inf.common.support.rabbitmq.EnableRabbit;
 ...
 * @date 2018年2月27日 下午4:27:06
 */
@JoindataWebApp(id = "DEMO.PANGU")
@EnableDisconf
@EnableRabbit
@EnableSwagger("RabbitMQ 使用例子")
public class App
{
    static
    {
        ...
        System.setProperty("app.version", "RabbitMQ");
    ...
    // XXX 说明
    // - 要使用 RabbitMQ 客户端，必须在 Disconf 中必须要有个 rabbitmq.properties 文件，请登录 Disconf 在 DEMO.PANGU > RabbitMQ 中查看
