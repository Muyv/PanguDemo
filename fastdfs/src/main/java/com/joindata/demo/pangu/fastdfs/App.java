package com.joindata.demo.pangu.fastdfs;
 ...
 * @date 2018年2月27日 下午4:26:37
 */
@JoindataWebApp(id = "DEMO.PANGU")
@EnableDisconf
@EnableFastDfs
@EnableSwagger("FastDFS 文件上传下载例子")
public class App
{
    static
    {
        ...
        System.setProperty("app.version", "FastDFS");
    ...
    // XXX 说明
    // - 要使用 ID 生成器，必须在 Disconf 中必须要有个 fastdfs.properties 文件，请登录 Disconf 在 DEMO.PANGU > FastDFS 中查看
