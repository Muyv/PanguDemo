package com.joindata.demo.pangu.paho;
...
import com.joindata.inf.common.support.paho.EnablePaho;
 ...
 * @date 2018年2月27日 下午4:26:58
 */
@JoindataWebApp(id = "DEMO.PANGU")
@EnableDisconf
@EnablePaho
@EnableSwagger("Paho 使用例子")
public class App
{
    static
    {
        ...
        System.setProperty("app.version", "Paho");
    ...
    // XXX 说明
    // - 要使用 Paho 客户端，必须在 Disconf 中必须要有个 paho.properties 文件，请登录 Disconf 在 DEMO.PANGU > Paho 中查看
