package com.joindata.demo.pangu.shardingjdbc;
...
import com.joindata.inf.common.support.idgen.EnableIdgen;
import com.joindata.inf.common.support.mybatis.EnableMyBatis;
import com.joindata.inf.common.support.shardingjdbc.EnableShardingJdbc;
...
public class App
{
    static
    {
        ...
        System.setProperty("app.version", "ShardingJDBC");
    ...
    // XXX 说明
    // - 要使用 ID 生成器，必须在 Disconf 中必须要有个 idgen.properties 文件，请登录 Disconf 在 DEMO.PANGU > ShardingJDBC 中查看
    // TODO - 要使用 MyBatis，必须在 Disconf 中必须要有个 jdbc.properties 文件，请登录 Disconf 在 DEMO.PANGU > ShardingJDBC 中查看
    // - 要使用 ShardingJDBC，必须在 Disconf 中必须要有个 shardingjdbc.properties 文件，请登录 Disconf 在 DEMO.PANGU > ShardingJDBC 中查看
