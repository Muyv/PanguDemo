package com.joindata.demo.pangu.elasticjob;
...
import com.joindata.inf.common.support.elasticjob.EnableElasticJob;
 ...
 * @date 2018年2月27日 下午4:26:30
 */
@JoindataWebApp(id = "DEMO.PANGU")
@EnableDisconf
@EnableElasticJob
@EnableSwagger("ElasticJob 使用例子")
public class App
{
    static
    {
        ...
        System.setProperty("app.version", "ElasticJob");
    ...
    // XXX 说明
    // - 要使用 ElasticJob，必须在 Disconf 中必须要有个 job.properties 文件，请登录 Disconf 在 DEMO.PANGU > ElasticJob 中查看
    // - 要监控 ElasticJob 和管理任务，请登录 http://10.10.110.50:8002 查看，登录参数: admin/adminjoindata123
